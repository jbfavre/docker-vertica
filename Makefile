...
push: push-8.0 push-7.2 push-7.1 push-7.0
...
push-7.2: build-7.2
	docker tag jbfavre/vertica:7.2.3-15_debian-7 jbfavre/vertica:latest
...
build: build-8.0 build-7.2 build-7.1 build-7.0
